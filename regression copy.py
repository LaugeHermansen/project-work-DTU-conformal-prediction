...
from Toolbox.tools import get_all_cp_models, multiple_split, evaluate
...
train_X, cal_X, test_X, train_y, cal_y, test_y, train_strat, cal_strat, test_strat = multiple_split((0.33,0.33,0.33), X_standard,y,stratify, keep_frac = .3)
